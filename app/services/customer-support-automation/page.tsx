    ...
    <main className="min-h-screen bg-[#050816] text-white">
      <section className="mx-auto max-w-7xl px-6 pb-24 pt-32">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-8 text-5xl font-bold tracking-tight md:text-7xl">
            Automatisiere deinen Kundensupport.
          </h1>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[
            "Bestellstatus automatisch beantworten",
            "Versandfragen automatisch bearbeiten",
            "Retourenanfragen vorsortieren",
            "FAQ-Anfragen mit KI beantworten",
            "Support-Tickets automatisch kategorisieren",
            "Standardantworten automatisiert versenden",
          ].map((item) => (
            <div
              key={item}
          ...
          {[
            {
              number: "01",
              title: "Analyse",
              text: "Wir analysieren deine häufigsten Support-Anfragen.",
            },
            {
              number: "02",
              title: "Planung",
            ...
            },
            {
              number: "03",
              title: "Umsetzung",
              text: "Wir bauen die Workflows und verbinden deine Systeme.",
            },
            {
              number: "04",
              title: "Test",
              text: "Wir testen Antworten, Sonderfälle und Übergaben an Menschen.",
            },
            {
              number: "05",
              title: "Optimierung",
              text: "Wir verbessern den Prozess anhand echter Support-Fälle.",
            },
          ].map((step) => (
            <div
              key={step.number}
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="rounded-[2rem] border border-indigo-500/20 bg-indigo-500/10 p-10 text-center md:p-16">
          <h2 className="text-4xl font-bold md:text-5xl">
            Weniger repetitive Anfragen. Mehr Zeit für echte Kundenprobleme.
          </h2>

          <p className="mx-auto mt-5 max-w-2xl text-gray-400">
            Wir entwickeln einen Support-Workflow, der zu deinem Unternehmen und
            deinen bestehenden Systemen passt.
          </p>
